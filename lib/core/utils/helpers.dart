...
//import 'package:ma7lola/core/model/products_response.dart';
import 'package:ma7lola/core/utils/snackbars.dart';
//import 'package:ma7lola/core/model/address.dart';
...
*/
  ...
  static String formatPrice(num price) => '${price.toStringAsFixed(2)} ';
  ...
  static Future<DateTime?> showDateTimePicker(BuildContext context) async {
    ...
    var time =
        TimeOfDay.fromDateTime(selectedDate.add(const Duration(minutes: 60)));
