...
import '../widgets/fixed_cached_network_image.dart';
        ...
        child: Row(
          ...
          children: [
            ClipRRect(
              ...
              child: FixedCachedNetworkImage(  errorWidget: (context, url, error) => Container(height: 150.0, child: Icon(Icons.error),),
